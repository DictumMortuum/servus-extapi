...
func Database() (*gorm.DB, *sql.DB, error) {
	...
	db.AutoMigrate(&model.Boardgame{}, &model.Play{}, &model.Player{}, &model.Stat{}, &model.Price{}, &model.Store{}, &model.Location{}, &model.BGStatsPlayer{}, model.BGStatsLocation{}, model.BGStatsGame{}, model.BGStatsPlay{}, model.BGStat{})
	return db, sqlDB, nil
}
